...
import teamImage from '../assets/backgrounds/team-image.webp'
...
export default function Login() {
   ...
   login({
      ...
      role: res.data.role,   // 'CLIENT', 'ORGANISATEUR', 'ADMIN'
      token: res.data.token
   })

   // Redirection selon le rôle
   if (res.data.role === 'ADMIN') navigate('/admin/dashboard')
   else if (res.data.role === 'ORGANISATEUR') navigate('/orga/dashboard')
   else navigate('/')
   }
         ...
         <div
            ...
            <div className="grid md:grid-cols-2 items-center gap-x-8 gap-y-12">
               <div className="max-w-md mx-auto w-full p-2 md:p-4">
                  ...
                  <div>
                     <Link to={'https://accounts.google.com/v3/signin'}
                  ...
                  <div className="mt-6 text-slate-900 text-sm text-center">Don't have an account? <Link to={'/register'}
               ...
               <div
                  ...
                  <img src={teamImage} className="w-full h-full object-cover" alt="login img" />
